	...
	<body>
		<div class="dvheader">
			<div class="dvheadertools">
				<span class="headerspantitle">文章管理系统</span>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					<i class="icon-cog menuicon"></i>菜单<b class="arrow icon-angle-down arrow-down"></b>
					<ul class="ulleftsubitems">
						<%--TUDO等下修改--%>
						<a href="/article_admin" target="right">
							<li>文章管理</li>
						</a>
					</ul>
				</li>
			...
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe scrolling="no" width="100%" height="1200" name="right" border="none">
					<jsp:include page="article_admin.jsp"></jsp:include>
				</iframe>
			</div>
		</div>
